...
| d | Historical upgrade-stability panel retained in the generated artifact but excluded from current manuscript experiment content. | Not used as formal manuscript evidence. | Do not cite as Lab3, scheduled/immediate baseline, or consistency experiment. | Excluded from current Evaluation. | n/a |
