...
contract Pbkdf2Sha256Solidity {
    ...
    function Pbkdf2Sha256(
        ...
        require(iterations > 0 && iterations <= PBKDF2_MAX_ITERATIONS, "invalid iterations");
        require(keyLength <= PBKDF2_MAX_KEY_LENGTH, "invalid key length");
        if (keyLength == 0) {
            return "";
        }
