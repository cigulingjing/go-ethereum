...
func parseFlags() config {
	...
	flag.StringVar(&cfg.outputDir, "output-dir", "cryptoupgrade/results/execution-efficiency", "directory used when -output-json is empty")
...
func compressSource(path string) (int, string, error) {
	...
	return raw.Len(), base64.StdEncoding.EncodeToString(compressed.Bytes()), nil
}
