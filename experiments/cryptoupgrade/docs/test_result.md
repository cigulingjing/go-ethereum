...
- Blake2b Sum256 部署阶段中，升级方案耗时高于 Solidity 纯合约，Mean 约为 `1.70x`；当前实现中 upload receipt 与事件驱动 activation 分离，后续结果应区分 submit-to-receipt 和 receipt-to-callFunc-success。
